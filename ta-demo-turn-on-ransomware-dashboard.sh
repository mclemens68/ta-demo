...
curl -u $ILO_API_KEY:$ILO_API_TOKEN -H "Content-Type: application/json" -X PUT -d '[{"name":"ransomware_readiness_dashboard","enabled":true}]' $ILO_SERVER/api/v2/orgs/1/optional_features
